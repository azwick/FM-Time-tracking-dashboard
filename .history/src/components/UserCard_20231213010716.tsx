    ...
    return (
        <section className={styles.userCard}>
            ...
            <ul className={styles['userCard-nav-list']}>
                <li key={1} className={timeFilter === "daily" ? styles.active : ''} onClick={handleClick}>Daily</li>
                <li key={2} className={timeFilter === "weekly" ? styles.active : ''} onClick={handleClick}>Weekly</li>
                <li key={3} className={timeFilter === "monthly" ? styles.active : ''} onClick={handleClick}>Monthly</li>
            </ul>
            </nav>
        </section> 
    )    
