    ...
    return (
        <section className={styles.userCard}>
            ...
            <ul className={styles['userCard-nav-list']}>
                ...
                <li className={`${styles['userCard-nav-list-item']} ${timeFilter === 'weekly' ? styles.active : ''}`} onClick={handleClick}>Weekly</li>
                <li className={`${styles['userCard-nav-list-item']} ${timeFilter === 'monthly' ? styles.active : ''}`} onClick={handleClick}>Monthly</li>
            </ul>
            </nav>
        </section> 
    )    
